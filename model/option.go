...
func InitOptionMap() {
	...
	common.OptionMap["RechargeRebateEnabled"] = strconv.FormatBool(common.RechargeRebateEnabled)
	common.OptionMap["RechargeRebateRatio"] = strconv.FormatFloat(common.RechargeRebateRatio, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RechargeRebateEnabled":
		common.RechargeRebateEnabled, _ = strconv.ParseBool(value)
	case "RechargeRebateRatio":
		common.RechargeRebateRatio, _ = strconv.ParseFloat(value, 64)
