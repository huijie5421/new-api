...
import { formatDuration, formatResetPeriod, formatQuotaLabel, formatQuotaLabelByReset } from '@/features/subscriptions/lib'
import type {
  PlanRecord,
            ...
            {plans.map((p, index) => {
              ...
              const benefits = [
                ...
                formatResetPeriod(plan, t) !== t('No Reset')
                  ...
                  : null,
                totalAmount > 0
                  ? `${formatQuotaLabel(plan, t)}: ${formatQuota(totalAmount)}`
                  : `${formatQuotaLabel(plan, t)}: ${t('Unlimited')}`,
