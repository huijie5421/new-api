...
export const STATIC_I18N_KEYS = [
  ...
  'AIGC Workshop',
  '电商精修',
  '文字模型先策划，生图模型按主图、白底、场景和细节执行。',
  '批量出图',
  '优先低等待和稳定输出，适合快速跑一批商品素材。',
  '社媒海报',
  '偏竖版内容平台，强化生活方式、卖点和营销横幅。',
  '短视频',
  '优先视频模型和参考素材复用，保留图片参数给封面生成。',
  'Model Square',
  'Rankings',
  'Docs',
  'About',
  ...
  // AIGC workshop
  'Prompt to production-ready image assets',
  'Text or reference image to short video tasks',
  'Batch product scenes for storefront campaigns',
  '1K Standard',
  '2K HD',
  '4K Ultra',
  'Auto',
  'AI selects a suitable ratio',
  'Square',
  'Avatar / product hero image',
  'Landscape',
  'Cover / poster',
  'Portrait',
  'Mobile poster / Xiaohongshu',
  '4:3 Landscape',
  ...
  'Product banner',
  '21:9 Ultrawide',
  'Wide campaign visual',
  'Main Product Image',
  'clean hero product image, premium lighting, isolated product focus',
  'Lifestyle Scene',
  'realistic lifestyle scene, natural use case, commercial photo',
  'Detail Close-up',
  'macro detail close-up, texture and material visible, ecommerce quality',
  'Campaign Banner',
  'wide campaign banner composition, space for copy, retail promotion',
  'Unified creative workspace for images and videos.',
  'Require login to use AIGC Workshop',
