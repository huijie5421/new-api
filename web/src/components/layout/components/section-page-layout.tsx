...
export function SectionPageLayout(props: SectionPageLayoutProps) {
  ...
  return (
    <PageFooterProvider container={footerContainer}>
      <Main>
        <div className='section-page-header shrink-0 px-3 pt-3 pb-2.5 sm:px-4 sm:pt-5 sm:pb-3'>
          {breadcrumb != null && (
            <div className='mb-2 sm:mb-3'>{breadcrumb}</div>
          )}
          <div className='section-page-heading flex flex-wrap items-center justify-between gap-x-3 gap-y-2 sm:gap-x-4'>
