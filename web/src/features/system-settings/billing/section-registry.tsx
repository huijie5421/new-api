    ...
    build: (settings: BillingSettings) => (
      <QuotaSettingsSection
        defaultValues={{
          ...
          RechargeRebateEnabled: settings.RechargeRebateEnabled,
          RechargeRebateRatio: settings.RechargeRebateRatio,
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          GMPayAddress: settings.GMPayAddress ?? '',
          GMPayId: settings.GMPayId ?? '',
          GMPayKey: settings.GMPayKey ?? '',
          GMPayPayMethods: settings.GMPayPayMethods ?? '[]',
