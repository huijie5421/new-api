...
export function SummaryCards() {
  ...
  return (
    <div className='dashboard-kpi-board bg-card overflow-hidden rounded-2xl border shadow-xs'>
      <div className='grid xl:grid-cols-[minmax(0,1fr)_19rem]'>
        <div className='dashboard-kpi-main flex flex-col gap-2.5 p-3 sm:gap-3 sm:p-5'>
          ...
          <StaggerContainer className='grid grid-cols-3 gap-1.5 sm:gap-3'>
            {items.map((it) => (
              <StaggerItem
                key={it.key}
                className='dashboard-kpi-item bg-background/60 rounded-lg border px-2 py-1.5 sm:rounded-xl sm:p-3'
              >
                <StatCard
                  title={it.title}
                  value={it.value}
        ...
        <div className='dashboard-credit-rail flex flex-col justify-between gap-3 border-t p-3 sm:gap-4 sm:p-5 xl:border-t-0 xl:border-l'>
