...
func TestChannelListHasSlashlessCompatibilityRoute(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "", authz.ChannelRead, controller.GetAllChannels)
}
