	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/rebate", controller.GetSelfRebateRecords)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/channel_health_router", controller.GetChannelHealthRouterStats)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.POST("/batch/keys", middleware.TokenKeyRateLimit(), middleware.DisableCache(), controller.GetTokenKeysBatch)
		}
